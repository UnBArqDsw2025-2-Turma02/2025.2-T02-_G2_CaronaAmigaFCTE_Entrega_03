...
Para a seção de padrões estruturais desta entrega, a equipe organizou-se em três subgrupos com responsabilidades claras sobre os padrões selecionados. O foco do nosso trabalho foi documentar tanto a modelagem quanto a implementação Java de cada padrão.
