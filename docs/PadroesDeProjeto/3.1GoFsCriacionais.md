...
| **Grupo 2** | Pesquisar e documentar o padrão **Builder**, explicando sua intenção, estrutura e aplicabilidade.               | Amanda Cruz, Arthur Sousa e Cauã Araujo.                                                               |
| **Grupo 3** | Pesquisar e documentar o padrão **Singleton**, detalhando seus componentes, benefícios e desvantagens.          | Caio Venâncio, Caio Melo, Maria Eduarda e Pedro Henrique.                                              |
